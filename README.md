> [!WARNING]
> This project is no longer maintained as it is outdated. A severely updated version of this project can be found [Here](https://github.com/IStayThatWayCoding/Sage)
