...
module.exports = {
    ...
    run: async (bot, message, args) => {
        if(!message.member.permissions.has("ADMINISTRATOR")) return;
            ...
            let faq1 = '**About**\n\nAge: 19\nPronouns: She/Her 🏳️‍⚧️\nFavorite Colors: Pastel blue, pastel pink, sky blue, aqua, and black\nFavorite Mainstream Music Artists: Juice WRLD, The Kid LAROI, Post Malone, etc.\nFavorite Mainstream Song: The Kid LAROI - Stay (ft. Justin Bieber)\nFavorite Games: Minecraft, Super Smash Bros. Ultimate, and **TONS of Sonic games.**\nFavorite Sonic Song(s): "Reach For The Stars" from Sonic Colors, "I\'m Here" from Sonic Frontiers, "Undefeatable" from Sonic Frontiers, and "Knight of The Wind" from Sonic and The Black Knight'
